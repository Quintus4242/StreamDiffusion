    ...
    def _load_model(
        ...
        def get_sd_model_config(model_type):
            ...
            config_urls = {
                ...
                # "sdxl-refiner": "https://raw.githubusercontent.com/Stability-AI/generative-models/main/configs/inference/sd_xl_refiner.yaml",
                "sdxl-turbo": "https://raw.githubusercontent.com/Stability-AI/generative-models/main/configs/inference/sd_xl_base.yaml",
                # "upscaler": "https://raw.githubusercontent.com/Stability-AI/stablediffusion/main/configs/stable-diffusion/x4-upscaling.yaml"
            }
            ...
            with open(config_path, "rb") as f:
                # print(f"\nUsing SD Config {config_path}")
                return BytesIO(f.read())

        original_config = get_sd_model_config(config_type)
        ...
        if lora_dict is not None:
            try:
                ...
                error_message = str(e)[:400]  # Limit error message to 400 characters
