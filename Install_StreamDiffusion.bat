            ...
            cd /d "C:/Users/quint/Documents/GitHub/StreamDiffusion/StreamDiffusion"
            echo Changed directory to: %CD%
            set "PIP_DISABLE_PIP_VERSION_CHECK=1"
            if not exist "venv" (
                echo Creating Python venv at: "C:/Users/quint/Documents/GitHub/StreamDiffusion/StreamDiffusion\venv"
                "C:/Users/quint/AppData/Local/Programs/Python/Python310/python.exe" -m venv venv
            ) else (
                echo Virtual environment already exists at: "C:/Users/quint/Documents/GitHub/StreamDiffusion/StreamDiffusion\venv"
            )
            ...
            if "%VIRTUAL_ENV%" == "" (
                ...
                echo Path to venv: "C:/Users/quint/Documents/GitHub/StreamDiffusion/StreamDiffusion\venv"
